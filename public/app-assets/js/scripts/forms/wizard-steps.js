...
$(".wizard-vertical").steps({
  ...
  onFinished: function (event, currentIndex) {
    ...
    // var formData = new formData();
      ...
      // formData.append("userfile", $('file[name=profile_pic]').files[0]);
      ...
      "data": formData,
        ...
        success: function (response) {
          alert("Employee information added succefully!");
          location.reload();
      },
      error: function (jqXhr, status, errorMessage) {
        ...
        if(jqXhr.status === 422){
            ...
            $.each(errors, function (index, value) {
                ...
                $("#all-error").append("<div><small class='form-text validation-error'>"+value[0]+"</small></div>");
            });
            $('#employeeForm-t-0').click();
