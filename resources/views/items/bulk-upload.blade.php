        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        {!! Form::open(['url' => 'item/upload/store','files'=>'true']) !!}
                            <div class="alert alert-info mb-2" role="alert">
                               Please find this <a href="{{asset('app-assets/sample_templates/sample_item_upload.xlsx')}}">sample format</a>. Keep the header row and put the data from 2nd row.
                            </div>
                            ...
                            <fieldset class="form-group">
                                ...
                                <div class="custom-file">
                                    <!-- <input type="file" class="custom-file-input" id="attendance_file"> -->
